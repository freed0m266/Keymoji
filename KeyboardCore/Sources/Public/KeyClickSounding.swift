...
/// emits the click when the controller's *visible input view* adopts `UIInputViewAudioFeedback`
/// (the controller itself is not inspected) **and** the user has "Keyboard Clicks" enabled in
/// Settings → Sounds & Haptics, **and** the extension has Allow Full Access. The system gates
